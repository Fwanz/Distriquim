...
<head>
    ...
    <link rel="stylesheet" type="text/css" media='all and (max-width: 1599px)'
          href="./css/notebook.css?d=<?php echo time(); ?>"/>
    <link rel="stylesheet" type="text/css" media='all and (max-width: 1024px)'
          href="./css/mobile.css?d=<?php echo time(); ?>"/>
